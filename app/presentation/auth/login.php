...
$mensajes = [
    'requiere_login' => 'Debes iniciar sesión para acceder a esta página.',
    'requiere_admin' => 'Se requieren permisos de administrador.',
    ...
    <div style="display: flex; min-height: 100vh; width: 100%;">
            ...
            <div style="width: 100%; max-width: 400px;">
                ...
                <?php if ($msg && isset($mensajes[$msg])): ?>
                    <div class="alert alert-warning">
                        ...
                        <?php echo htmlspecialchars($mensajes[$msg]); ?>
                    </div>
                <?php endif; ?>
                ...
                <!-- Login Form -->
                <form method="POST" action="index.php?view=procesar_login">
                    ...
                    <div style="margin-bottom: 1rem; position: relative;">
                        ...
                        <input type="password" id="password" name="password" required autocomplete="current-password"
                            ...
                            onblur="this.style.borderBottomColor='#ddd'">
                        <i class="fas fa-eye"
                            style="position: absolute; right: 0; bottom: 0.75rem; color: #999; cursor: pointer; font-size: 0.9rem;"></i>
                    </div>

                    <!-- Forgot Password -->
                    <div style="text-align: right; margin-bottom: 2rem;">
                        <a href="#" style="font-size: 0.85rem; color: #999; text-decoration: none;">Forgot password?</a>
                    </div>
        ...
        <div
            ...
            <p style="font-size: 1rem; margin-bottom: 2.5rem; text-align: center; max-width: 400px; opacity: 0.95;">Sign
                up and discover great amount of new opportunities!</p>
